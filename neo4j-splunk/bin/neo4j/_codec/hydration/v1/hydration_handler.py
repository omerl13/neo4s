...
class _GraphHydrator(GraphHydrator):
    ...
    def hydrate_relationship(
        self, id_, n0_id, n1_id, type_, properties=None, element_id=None, n0_element_id=None, n1_element_id=None
    ):
        # backwards compatibility with Neo4j < 5.0
        if element_id is None:
            element_id = str(id_)
        ...
        inst = self.hydrate_unbound_relationship(id_, type_, properties, element_id)
    ...
    def hydrate_unbound_relationship(self, id_, type_, properties=None, element_id=None):
        assert isinstance(self.graph, Graph)
        # backwards compatibility with Neo4j < 5.0
        if element_id is None:
            element_id = str(id_)
