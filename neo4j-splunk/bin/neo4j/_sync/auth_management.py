...
class StaticAuthManager(AuthManager):
    ...
    def handle_security_exception(self, auth: _TAuth, error: Neo4jError) -> bool:
        return False
...
class Neo4jAuthTokenManager(AuthManager):
    ...
    def __init__(self, provider: t.Callable[[], t.Union[ExpiringAuth]], handled_codes: t.FrozenSet[str]) -> None:
...
class AuthManagers:
    ...
    @staticmethod
    def basic(provider: t.Callable[[], t.Union[_TAuth]]) -> AuthManager:
    ...
    @staticmethod
    def bearer(provider: t.Callable[[], t.Union[ExpiringAuth]]) -> AuthManager:
