...
class AsyncGraphDatabase:
    ...
    if t.TYPE_CHECKING:
        ...
        @classmethod
        def driver(cls, uri: str, *, auth: t.Union[_TAuth, AsyncAuthManager] = None, **config) -> AsyncDriver:
            """Create a driver.
...
class AsyncDriver:
    ...
    async def execute_query(
        ...
        bookmark_manager_: t.Union[AsyncBookmarkManager, BookmarkManager, None] = ...,
        auth_: _TAuth = None,
        result_transformer_: t.Callable[[AsyncResult], t.Awaitable[EagerResult]] = ...,
        **kwargs: t.Any,
    ) -> EagerResult: ...
    ...
    async def execute_query(
        ...
        bookmark_manager_: t.Union[
            AsyncBookmarkManager, BookmarkManager, None, te.Literal[_DefaultEnum.default]
        ] = _default,
        auth_: _TAuth = None,
        result_transformer_: t.Callable[[AsyncResult], t.Awaitable[t.Any]] = AsyncResult.to_eager_result,
        **kwargs: t.Any,
    ) -> t.Any:
    ...
    if t.TYPE_CHECKING:
        ...
        async def verify_authentication(
            self, auth: t.Union[Auth, t.Tuple[t.Any, t.Any], None] = None, **config
        ) -> bool:
