        ...
        def iteritems(self):
            ...
            return ifilter(
                ...
                imap(
                    ...
                    ifilter(lambda setting: setting.is_supported_by_protocol(version), definitions),
                ),
            )
...
def dispatch(
    command_class, argv=sys.argv, input_file=sys.stdin, output_file=sys.stdout, module_name=None, allow_empty_input=True
):
