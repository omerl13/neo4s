    ...
    **Example**::
    ...
    def __init__(self, handler=None, **kwargs):
        self.http = HttpLib(
            ...
            context=kwargs.get("context"),  # Default to False for backward compat
    ...
    def _abspath(self, path_segment, owner=None, app=None, sharing=None):
        ...
        **Example**::
        ...
        path = UrlEncoded("/servicesNS/%s/%s/%s" % (oname, aname, path_segment), skip_encode=skip_encode)
        return path
...
class HTTPError(Exception):
    ...
    def __init__(self, response, _message=None):
        ...
        try:
            ...
            detail = body
        message = "HTTP %d %s%s" % (status, reason, "" if detail is None else " -- %s" % detail)
